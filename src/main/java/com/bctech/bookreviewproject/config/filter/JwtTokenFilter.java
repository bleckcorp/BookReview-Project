package com.bctech.bookreviewproject.config.filter;
...
//        else if (request.getServletPath().startsWith("/swagger-ui") || request.getServletPath().startsWith("/v3/api-docs") || request.getServletPath().startsWith("/swagger-resources")) {
//            filterChain.doFilter(request, response);
//        }
        else {
